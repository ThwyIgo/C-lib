...
*/
extern void del_linhas_ram(int ini_deletar, int fim_deletar, FILE *arquivo, char mode_return[], long int arq_size);
...
*/
extern void del_linhas(int ini_deletar, int fim_deletar, FILE *arquivo, char mode_return[]);
